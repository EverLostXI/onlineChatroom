...
template <> constexpr inline auto AddFriendDialog::qt_create_metaobjectdata<qt_meta_tag_ZN15AddFriendDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onAddFriendResponse'
        QtMocHelpers::SlotData<void(bool, uint8_t)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
...
void AddFriendDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onAddFriendResponse((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uint8_t>>(_a[2]))); break;
        default: ;
        }
    }
}
